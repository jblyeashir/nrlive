...
<head>
    ...
    <title>Webful Education HTML Template | Contact Us</title>
                ...
                <div class="medium-8 small-12 columns">
                    <ul class="accordion" data-accordion>
                        ...
                        <li class="accordion-item" data-accordion-item>
                            <a href="#" class="accordion-title">Shipping Address</a>
                            <div class="accordion-content" data-tab-content>
								Here Come Shipping Address Form.
                            </div>
                        </li>

                        <li class="accordion-item" data-accordion-item>
                            <a href="#" class="accordion-title">Card Details</a>
                            <div class="accordion-content" data-tab-content>
								Here come your Card or payment Details.
                            </div>
                        </li>
                    ...
                    <div class="widget">
                        ...
                        <table class="hover">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        Once upon a time there was a thirsty crow.<strong>× 1</strong>													
                                    </td>
                                    <td>
                                        <span>$&nbsp;850.00</span>						
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        He flew here and there in search of water.<strong>× 1</strong>													
                                    </td>
                                    <td>
                                        <span>$&nbsp;850.00</span>						
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        At last he reached in a garden where he saw a pitcher.<strong>× 1</strong>													
                                    </td>
                                    <td>
                                        <span>$&nbsp;850.00</span>						
                                    </td>
